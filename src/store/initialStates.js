export const privacyPolicy = [
  ...
  {
    type: 'p',
    content: `Every Producer has the right to own and control their content and personal data through a personal data account(“Data Account”) that provides you alone with full control over the data in your Data Account.To create a Data Account with us you need to complete a two- step process: `
  },
  {
    type: 'p',
    content: `First, you need to access a social media account that you control and download your data to a device you own and control.We refer to this as “Step One.”
  ...
  {
    type: 'p',
    content: `We(or our partners) then provide tools that allow each Producer to populate their data account with compilations of data they want to control and secure like online content, preferences, and information from social networks(collectively, the “Producer Data”).`
  },
  {
    type: 'p',
    content: `You own and have full control over any Producer Data and your Data Account.`
  },
  {
    type: 'h',
    content: `Your Rights`
  ...
  {
    type: 'p',
    content: `You have the following rights.Please note we may have lawful reasons to deny requests related to the rights below: `
  },
  {
    type: 'p',
    content: `The right to be informed: You have the right to be informed of our purposes for processing your personal data, our retention periods for that personal data, and who it will be shared with.
...
Rights in relation to automated decision making and profiling: You have rights related to automated decision making any profiling.Please note that the Company does not make any such automated decision making or profiling.
  ...
  {
    type: 'p',
    content: `Your Company Products work in conjunction with a Producer account on the Site(a “Producer Account”).`
  },
  {
    type: 'p',
    content: `When you sign up for a Producer Account, you are required to provide an email address(which will be used as your login ID) and to create an account password(collectively the “Registration Information”).
  ...
  {
    type: 'p',
    content: `Company uses your personal information to:
  ...
  {
    type: 'p',
    content: `Company may ask you to participate in surveys designed to help Company improve the Service.Any personal information provided to Company in connection with any survey will be used only in relation to that survey and as elsewhere set forth in this Policy.`
  },
  {
    type: 'h',
    content: `Children`
  ...
  {
    type: 'p',
    content: `We do not knowingly collect any personal information from children under 13. If we discover that a child under the age of 13 has provided us with personally identifying information, we will take steps to delete the information as soon as possible.`
  },
  {
    type: 'p',
    content: `Email Communications From Us`
  },
  {
    type: 'p',
    content: `We may provide our registered customers with summaries of their Producer Account data and email alerts.We also allow Producers to subscribe to email newsletters and from time to time may transmit emails promoting Company or third - party goods or services.`
  },
  {
    type: 'p',
    content: `Company subscribers have the ability to opt - out of receiving our weekly summaries and promotional emails and to terminate their newsletter subscriptions by following the instructions provided in such emails.
  ...
  {
    type: 'p',
    content: `We use a combination of firewall barriers, encryption techniques and authentication procedures, among others, to maintain the security of your data and to protect Company accounts and systems from unauthorized access.`
  },
  {
    type: 'p',
    content: `When you register for the Service, Company requires a password from you for your privacy and security.This password is stored in an encrypted fashion on our systems.`
  },
  {
    type: 'p',
    content: `When you register for the Service, Company requires a password from you for your privacy and security.This password is stored in an encrypted fashion on our systems.`
  ...
  {
    type: 'h',
    content: `International Producers`
  },
  {
    type: 'p',
    content: `Company’s Services are hosted and operated entirely in the United States and are subject to United States law.Any personal information that you provide to Company is being provided to Company solely in the United States and will be hosted on United States servers.You consent to the transfer of your personal information to the United States.If you are accessing the Company Services from outside the United States, please be advised that United States law may not offer the same privacy protections as the law of your jurisdiction.`
  },
  {
    type: 'p',
    content: `If you have a security related concern, please contact us at info @datalucent.com.`
  },
  {
    type: 'h',
    content: `Updates to This Policy`
  },
  {
    type: 'p',
    content: `We may update this Policy periodically.The date last revised appears at the bottom of the Policy.Changes take effect immediately upon posting.`
  },
  {
    type: 'p',
    content: `If you have questions, comments, concerns or feedback regarding this Policy or any other privacy or security concern, send an e - mail to info @datalucent.com.`
  },
  {
    type: 'p',
    content: `This policy was last updated on 3 / 02 / 2021.`
  },
]



// foreach paragraph create
// {
//   type: 'p',
//     content: ``
// }

// foreach heading create
// {
//   type: 'h',
//     content: ``
// }